  ...
  try {
    ...
    */
    ...
    const book = {
      ...
      year: parseInt(event.target.elements[2].value),
      quantity: parseInt(event.target.elements[3].value)
    }
    console.log("handleEditform", book);
...
async function deleteBook(bookId) {
  try {
    ...
    */
    ...
    // Menghapus buku dari array `books` setelah berhasil dihapus dari server
